...
├── class-survey-automation/   # Condition-based monitoring scripts for hull/machinery
├── charter-smart-contracts/   # Solidity/Rust code for automated freight agreements
